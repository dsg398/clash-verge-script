...
function createRegionGroups({ name, icon, filter }) {
  ...
  const socialGroups = createGroups([
    ["AI", "https://cdn.jsdmirror.com/gh/dsg398/clash@main/icon/AI.png"],
    ["Google", "https://cdn.jsdmirror.com/gh/dsg398/clash@main/icon/Google.png"],
  ...
  const manualGroups = [
    {
      ...
      type: "select",
      proxies: ["节点选择", "DIRECT"],
      icon: "https://cdn.jsdmirror.com/gh/dsg398/clash@main/icon/Final.png"
    },
    {
      ...groupBaseOption,
      "name": "节点选择",
      "type": "select",
      "proxies": ["自动选择", "自动回退", "全部节点", "负载均衡", "DIRECT", "美国节点", "日本节点", "香港节点", "台湾节点", "新加坡节点"],
      "icon": "https://cdn.jsdmirror.com/gh/dsg398/clash@main/icon/Rocket.png"
    },
    {
      ...groupBaseOption,
      "name": "全部节点",
      ...
      "icon": "https://cdn.jsdmirror.com/gh/dsg398/clash@main/icon/Airport.png"
    },
    // 自动选择组
    {
      ...groupBaseOption,
